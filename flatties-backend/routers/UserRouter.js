...
router.get('/:userId/watchingList', watchingListController.getAllPropertiesInWatchingList);
...
router.put('/:userId/updateProperty/:propertyId', watchingListController.updateWatchingProperty);

//create a new user
router.post('/create', userController.createUser);  //test passed

//add a property to a watching list
router.post('/:userId/addProperty/:propertyId', watchingListController.addPropertyToWatchingList);

//remove a property from a watching list
router.delete('/:userId/removeProperty/:propertyId', watchingListController.removePropertyFromWatchingList);
